...
const Loading = ({ close, message }) => {
  return (
    <div className="justify-center items-center flex fixed inset-y-0 inset-x-0 z-20">
      ...
      ></div>
      {/* Modal */}
      <div className="bg-white p-5 rounded-lg  z-[200]  w-1/3 mx-auto relative flex items-center justify-center flex-col h-[300px]">
        <img src={loadingImage} alt="" className="w-4/12" />
